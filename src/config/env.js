...
export const env = cleanEnv(process.env, {
  ...
  DB_DEBUG_LOGGING: bool({ default: false }),
  CLAIM_LOGIN_ENABLED: bool({ default: true }),
  DASHBOARD_LOGIN_ENABLED: bool({ default: true }),
  REPOSTER_LOGIN_ENABLED: bool({ default: true }),
  DB_DRIVER: str({ default: 'postgres' }),
  REDIS_URL: str({ default: 'redis://localhost:6379' }),
  CORS_ORIGIN: str({ default: 'http://localhost:5173' }),
  AUTH_COOKIE_SAME_SITE: str({ default: 'lax' }),
  AUTH_COOKIE_SECURE: str({ default: 'false' }),
